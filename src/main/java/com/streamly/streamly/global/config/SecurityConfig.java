    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/advertiser/callback/**").permitAll()
                        .requestMatchers("/api/v1/advertiser/**").hasAnyRole("ADVERTISER", "ADMIN")
                        .requestMatchers("/api/v1/advertiser-requests/**").authenticated()
                        .requestMatchers("/api/v1/admin/ad-videos/**").hasRole("ADMIN")
